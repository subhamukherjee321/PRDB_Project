...
export default function Page() {
  ...
  const addNewProducts = async (data) => {
    let res = await axios.post("http://localhost:8080/products/add", data, {
      headers: {
        auth: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYzZTI4MTQyMjg5MTA3NmY4OWM0ZmY0MSIsImlhdCI6MTY3NjQ5MDgxNiwiZXhwIjoxNjc2NTI2ODE2fQ.BLQ39a9ZXUAHxFEwdaSeuGfCUY37g6k2B4IjjKFnHeQ"
      }
    });
    console.log('res: ', res);
  };
